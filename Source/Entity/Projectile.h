...
{
public:
	Projectile(glm::vec2 pos, glm::vec3 size, glm::vec2 colliderPosition, glm::vec3 colliderSize, glm::vec2 direction, std::unique_ptr<Sprite> sprite, glm::vec4 color = glm::vec4(1.0f));
	virtual ~Projectile();
