...
void SpriteRenderer::SetShader(glm::vec3 position, glm::vec2 size, float rotate, glm::vec4 color)
{
...
void SpriteRenderer::DrawTexture(Texture2D& texture, glm::vec3 position, glm::vec2 size, float rotate, glm::vec4 color)
{
